...
public class SunsetFragment extends Fragment {
	...
	public View onCreateView(final LayoutInflater inflater, final ViewGroup container, final Bundle savedInstanceState) {
		...
		hotSunColor = resources.getColor(R.color.hot_sun);
		sunColor = resources.getColor(R.color.bright_sun);
	...
	private void animateSunset() {
		...
		final ObjectAnimator heatAnimator = ObjectAnimator
			.ofInt(sunView, "backgroundColor", hotSunColor, sunColor);
		heatAnimator.setRepeatCount(8);
		heatAnimator.setEvaluator(new ArgbEvaluator());
