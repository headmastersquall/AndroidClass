...
public class PollService extends IntentService {
	...
	protected void onHandleIntent(final Intent intent) {
		...
		notifyIfNewImagesAreAvailable(this);
	}

	public static void notifyIfNewImagesAreAvailable(final Context context) {
		final String query = QueryPreferences.getStoredQuery(context);
		final String lastResultId = QueryPreferences.getLastResultId(context);
		...
		if (resultId.equals(lastResultId)) {
			...
			final Intent i = PhotoGalleryActivity.newIntent(context);
