...
public class ThumbnailDownloader<T> extends HandlerThread {
	...
	private LruCache<String, Bitmap> cache = new LruCache<>(300);
	...
	private Bitmap getImage(final String url) throws IOException {
		final Bitmap cachedImage = cache.get(url);
		if (cachedImage == null) {
